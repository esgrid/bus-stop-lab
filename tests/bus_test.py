...
class TestBus(unittest.TestCase):
    ...
    def test_starts_with_no_passengers(self):
        self.assertEqual(0, self.bus.how_many_passengers())

    # @unittest.skip("Delete this line to run the test")
    def test_can_pick_up_passenger(self):
        person = Person("Guido van Rossum", 64, 20)
        self.bus.pick_up_passenger(person)
        self.assertEqual(1, self.bus.how_many_passengers())

    # @unittest.skip("Delete this line to run the test")
    def test_can_drop_off_passenger(self):
        person = Person("Guido van Rossum", 64, 20)
        self.bus.pick_up_passenger(person)
        self.bus.drop_passenger(person)
        self.assertEqual(0, self.bus.how_many_passengers())
    ...
    def test_can_pick_up_passenger_from_bus_stop(self):
        ...
        person_2 = Person("Carol Willing", 50, 15)
        ...
        self.assertEqual(2, self.bus.how_many_passengers())
